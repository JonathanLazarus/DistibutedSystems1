...
public class Message {
    ...
    private ElectionNotification electionNotification;
    ...
    public String toString(){
        if(this.stringRepresentation == null){
            ...
            if(getMessageType() == MessageType.ELECTION){
                ...
                this.electionNotification =
                        new ElectionNotification(leader,
    ...
    protected ElectionNotification toElectionNotification() {
        if (this.electionNotification != null) return this.electionNotification;
        if(getMessageType() == MessageType.ELECTION) {
            ByteBuffer msgBytes = ByteBuffer.wrap(getMessageContents());
            long leader = msgBytes.getLong();
            char stateChar = msgBytes.getChar();
        ...
        return this.electionNotification;
    }
}